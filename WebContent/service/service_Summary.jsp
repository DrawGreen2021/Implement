	...
	<div width="1200px;" style="text-align:center; margin:5% auto;">
		...
		<div class="content_div" style="text-align:left;">
			<div width="930px" height="500px">
				<h1 style="font-size:40px; color:#180E5A;">팀 그릴그린에서 기업정보 웹 서비스, <br>“CorpCollector”을 제작했습니다</h1>
				<br><br>
				<p>이는 단순히 기업 목록을 제공하는 서비스가 아니라, 선한 기업, 즉 사회적으로 유익한 활동을 하는 기업의 정보를 보여줍니다. 
				...
				하고자 합니다.</p>
				<br>
				<p>서비스 소개: 어떤 서비스를 제공하는 사이트인지 설명하는 페이지입니다. <br>
					서비스 개요 - 서비스 제작 배경 및 간략한 설명이 적혀있습니다. <br>
					개발 과정 - 팀 그릴그린 팀원들의 역할별 개발 과정을 보여줍니다. <br><br>

				기업 찾기: 기업 정보를 검색할 수 있는 페이지입니다. <br>
					'기업 찾기' 클릭 시 - 통합 검색 창으로 이동합니다. <br>
					녹색 기업, 인재 육성형 중소 기업, 사회적 기업, 가족 친화 기업, 청년 친화 강소 기업 - 각 유형별 기업 목록 보기와 검색 서비스를 이용할 수 있습니다. <br>
					기업명을 클릭하면 상세 기업 정보를 볼 수 있습니다. <br><br>

				정보 나눔: 기업 데이터를 분석하고 기업 찾기에 있는 각 기업 유형별 관련 뉴스를 제공하는 페이지입니다. <br>
					기업 데이터 분석 - 공공데이터포털에서 제공하는 기업 데이터를 분석해 결과를 시각화하여 보여줍니다. <br>
					기업 기사 모음 - 공공데이터에 나오지 않은 정보도 볼 수 있도록 유형별 기사를 수집해 제목과 링크를 모아놓았습니다. <br><br>
				
				커뮤니티: 공지사항 업로드 및 사용자와 소통하기 위한 페이지입니다. <br>
					공지사항 - 서비스 관련 공지사항을 볼 수 있습니다. <br>
					고객후기 - CorpCollector 사용 후기, 건의 사항, 문의 등을 남길 수 있습니다. <br><br>
				
				마이페이지: 회원가입을 한 사용자에게 제공되는 페이지입니다. <br>
					개인정보 관리 - 개인정보를 수정할 수 있습니다. <br>
