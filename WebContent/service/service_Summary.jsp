	...
	<div class="outer_block">
		...
		<div class="content_div" style="text-align:left;">
			<div width="930px" height="500px">
				...
				<br>
				<h3>서비스 소개</h3>
				<p>: 어떤 서비스를 제공하는 사이트인지 설명하는 페이지입니다. <br><br>
					서비스 개요 - 서비스 제작 배경 및 간략한 설명이 적혀있습니다. <br>
					개발 과정 - 팀 그릴그린 팀원들의 역할별 개발 과정을 보여줍니다. <br><br></p>

				<h3>기업 찾기</h3>
				<p>: 기업 정보를 검색할 수 있는 페이지입니다. <br><br>
					'기업 찾기' 클릭 시 - 통합 검색 창으로 이동합니다. <br>
					녹색 기업, 인재 육성형 중소 기업, 사회적 기업, 가족 친화 기업, 청년 친화 강소 기업 - 각 유형별 기업 목록 보기와 검색 서비스를 이용할 수 있습니다. <br>
					기업명을 클릭하면 상세 기업 정보를 볼 수 있습니다. <br><br></p>

				<h3>정보 나눔</h3>
				<p>: 기업 데이터를 분석하고 기업 찾기에 있는 각 기업 유형별 관련 뉴스를 제공하는 페이지입니다. <br><br>
					기업 데이터 분석 - 공공데이터포털에서 제공하는 기업 데이터를 분석해 결과를 시각화하여 보여줍니다. <br>
					기업 기사 모음 - 공공데이터에 나오지 않은 정보도 볼 수 있도록 유형별 기사를 수집해 제목과 링크를 모아놓았습니다. <br><br></p>
				
				<h3>커뮤니티</h3>
				<p>: 공지사항 업로드 및 사용자와 소통하기 위한 페이지입니다. <br><br>
					공지사항 - 서비스 관련 공지사항을 볼 수 있습니다. <br>
					고객후기 - CorpCollector 사용 후기, 건의 사항, 문의 등을 남길 수 있습니다. <br><br></p>
