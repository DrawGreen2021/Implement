	...
	<div class="outer_block" >
		...
		<div class="content_div" >
				...
				<tr>
					<table class="content_div_write">
						<tr class="community_text" height="30px;">
							...
							<td style="text-align:left; padding-left:12px;"><input type="text" name="title" autocomplete="off" class="write_input" maxlength="45" 
			...
			<button class="writing_btn" style="background-color:#E7F1FD;" 
				value="notice.jsp" id="cancel">취소</button> <!-- 취소 선택시 뒤로가기 -->
