	...
	<div class="outer_block">
		<div class="sidebar_div" style="float: left;">
			<aside class="sidebar">
				<ul style="list-style-type: none;">
					<h3>커뮤니티</h3>
					<p>
						<a href="<c:url value='/community/notice.jsp'/>"
							style="color: #e1bf27; font-weight: bold;">공지사항</a>
					</p>
					<p>
						<a href="<c:url value='/community/feedback.jsp'/>">고객 후기</a>
					</p>
				</ul>
			</aside>
		</div>
		...
		<div class="content_div" style="display: grid">
			<div class="search_div" style="width: 930px;">
				<form method="get" action="SearchPost.do" id="searchPost">
					<div class="bar_div">
						<input class="search_bar" type="text" id="search_keyword"
							name="keyword" autocomplete="off" placeholder=" 검색어를 입력하세요"
							style="margin: 10px; width: 800px; height: 53px;"> <input
							type="hidden" name="page" value="1"> <input type="hidden"
							name="boardName" id="boardName" value="공지사항">
					</div>
					<div class="btn_div">
