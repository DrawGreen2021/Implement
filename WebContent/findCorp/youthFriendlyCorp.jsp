	...
	<div class="outer_block">
		...
		<div class="content_div" style="display: grid">
			<div class="search_div" style="width: 930px;">
				<form action="FindCorp.do" method="get" name="findCorp"
					id="findCorp">
					<div class="bar_div">
						<input type="hidden" name="corpType" id="corpType"
							value="youthFriendlyCorp"> 
						<input type="hidden"
							name="page" value="1"> 
					...
					<c:when test="${not empty requestScope.corpList }">
						...
						<table class="content_div_findCorpList"
							...
							<tr class="community_text"
								...
								<td width="25%">소재지</td>
								<td width="11%">업종</td>
								<td width="13%">BEST 선정 분야 -임금</td>
								<td width="13%">BEST 선정 분야 -일생활균형</td>
								<td width="13%">BEST 선정 분야 -고용안정</td>
							</tr>
