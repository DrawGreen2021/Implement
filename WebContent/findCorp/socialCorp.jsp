				...
				<form align="center" action="FindCorp.do" method="get"
					...
					<div class="bar_div">
						...
						<input class="search_bar" type="text"
							id="search_keyword" autocomplete="off" placeholder=" 검색어를 입력하세요"
							name="keyword" style="margin: 10px; width: 800px; height: 53px;"
...
<<<<<<< HEAD
											...
											<td style="font-size:10pt;">${dto.business_contents }</td>
											<td>${dto.realization_type }</td>
											<td style="font-size:10pt;">${dto.representative_number }</td>
